                            ...
                            <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4 form-group mb-3">
                                        ...
                                        <input type="checkbox" name="featured" className="w-50 h-50" onChange={handleInput} value={productInput.featured} />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Popular (checked=shown):</label>
                                        <input type="checkbox" name="popular" className="w-50 h-50" onChange={handleInput} value={productInput.popular} />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Status (checked=hidden):</label>
                                        <input type="checkbox" name="status" className="w-50 h-50" onChange={handleInput} value={productInput.status} />
                                    </div>
